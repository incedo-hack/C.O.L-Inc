        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>ihrp</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Search Resume <span class="fa fa-chevron-down"></span></a>
                    <!--<ul class="nav child_menu">
                  ...
                  <li><a  href = 'recent_search.php'><i class="fa fa-desktop"></i> Recent Seaarches <span class="fa fa-chevron-down"></span></a>
                    <!--<ul class="nav child_menu">
                  ...
                  <li><a href ='buddy.php'><i class="fa fa-table"></i> Find buddy <span class="fa fa-chevron-down"></span></a>
                  <!--  <ul class="nav child_menu">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id = 'myform' method = 'POST' action = 'search_result.php'><br>
				  
				  <u><h3>select your website</h3></u><br>
				  
				  <input type ='CHECKBOX' name = 'web' value = 'Naukri'>Naukri.com
				  <input type ='checkbox' name = 'web' value ='match_any'> Indeed.com 
				   <input type ='checkbox' name = 'web' value ='match_any'> Monster.com
				    <input type ='checkbox' name = 'web' value ='match_any'> Linkedin.com
					<input type ='checkbox' name = 'web' value ='match_any'> Local Directory<br>
                  <textarea name="descr" id="descr" style="display:none;"></textarea><br>
				  
				     <u><h3>Fill your filters</u></h3><br>
				  <input type ='radio' name = 'match' value = 'match_all'>Match All
				  <input type ='radio' name = 'match' value ='match_any'> Match any <br>
				  <br>
				
				  <table>
				  <tr><td> <lable > key word 1 </lable><input type = 'text'> </td><td></td><td> <lable>Key word 1 </lable><input type = 'text'>  </td></tr>
				  <tr><td> <lable > key word 2 </lable><input type = 'text'> </td><td></td><td> <lable>Key word 2 </lable><input type = 'text'>  </td></tr>
				  <tr><td>  <lable > key word 3 </lable><input type = 'text'></td><td></td><td><lable>Key word 3 </lable><input type = 'text'>   </td></tr>
				  <tr><td> <lable > key word 4 </lable><input type = 'text'> </td><td></td><td><lable>Key word 4 </lable><input type = 'text'>   </td></tr>
				  </table>
				  <br>
